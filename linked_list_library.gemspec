...
Gem::Specification.new do |spec|
  ...
  spec.summary               = %q{A LinkedList library. Organizes the LinkedList
 components.}
  spec.description           = %q{A LinkedList library. Organizes the
LinkedList components. Donations support continuous improvement and maintenance.
 The aim is a reliable, integrable, and endurable LinkedList library. Make a
